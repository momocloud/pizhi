...
- [x] **Step 1: Write the failing brainstorm integration test**
...
- [x] **Step 1: Write failing tests for outline response parsing and command application**
...
- [x] **Step 1: Write failing tests for chapter context assembly and write command**
...
- [x] **Step 1: Write failing integration tests for batch continuation**
