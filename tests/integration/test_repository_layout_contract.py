...
def test_contributing_doc_mentions_setup_and_test_command(project_root):
    ...
    assert "current public stability tag for Git-backed installs is `v0.1.2`" in contributing
    assert "Stable consumer examples should prefer `@v0.1.2`." in contributing
